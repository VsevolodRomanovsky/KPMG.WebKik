...
@Component({
    template: require('./kik-company-list.component.html'),
    providers: [CompanyService]
})
export class CompanyKikListComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        Promise.all([
            this.companyService.getKIKByProjecCompanytId(this.companyId),
