...
var CompanyControlComponent = (function () {
    function CompanyControlComponent(companyService, route, _router) {
        this.companyService = companyService;
        this.route = route;
        this._router = _router;
    }
    CompanyControlComponent.prototype.ngOnInit = function () {
        var _this = this;
        ...
        this.companyService.get(this.companyId).then(function (result) {
            _this.model = result;
            _this.isLoading = false;
        });
    };
    CompanyControlComponent.prototype.onSubmit = function () {
        var _this = this;
        this.companyService.updateCompanyShare(this.model).then(function (result) {
            _this._router.navigate(['../'], { relativeTo: _this.route });
        });
    };
    CompanyControlComponent = __decorate([
        core_1.Component({
            template: require('./company-control.component.html'),
    ...
    return CompanyControlComponent;
}());
exports.CompanyControlComponent = CompanyControlComponent;
//# sourceMappingURL=company-control.component.js.map