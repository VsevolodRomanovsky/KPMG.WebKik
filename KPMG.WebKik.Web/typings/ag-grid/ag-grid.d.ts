...
declare module ag.grid {
    interface ColDef {
        ...
        cellRenderer?: (params: CellRenderParams<any>) => HTMLElement | string;
...
declare module ag.grid {
    interface GridOptions {
        ...
        onCellFocused?(params: { rowIndex: number, colIndex: number, node: RowNode }): void;
...
declare module ag.grid {
    class GridApi {
        ...
        getSelectedRows(): any[];
        getBestCostNodeSelection(): any;
        getRenderedNodes(): ag.grid.RowNode[];
        ensureColIndexVisible(index: any): void;
        ensureIndexVisible(index: any): void;
