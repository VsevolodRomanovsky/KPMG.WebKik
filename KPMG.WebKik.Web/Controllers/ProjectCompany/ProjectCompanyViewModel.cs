...
namespace KPMG.WebKik.Web.Controllers.ProjectCompany
{
    public class ProjectCompanyViewModel : IEntity<int>
    {
        ...
        {
            cfg.CreateMap<Models.ProjectCompanies.ProjectCompany, ProjectCompanyViewModel>()
                .ForMember(x => x.StateName, o => o.MapFrom(s => s.State.GetDescription()))
                ;

            cfg.CreateMap<ProjectCompanyViewModel, Models.ProjectCompanies.ProjectCompany>()
                ...
                .ForMember(x => x.OwnerProjectCompanyFactShares, y => y.Ignore())
                .ForMember(x => x.DependentProjectCompanyFactShares, y => y.Ignore())
                //.ForMember(x => x.Registers1, y => y.Ignore())
                //.ForMember(x => x.Registers2, y => y.Ignore())
                //.ForMember(x => x.Registers3, y => y.Ignore())
                //.ForMember(x => x.Registers4, y => y.Ignore())
                //.ForMember(x => x.Registers5, y => y.Ignore())
                //.ForMember(x => x.Registers6, y => y.Ignore())
                //.ForMember(x => x.Registers7, y => y.Ignore())
